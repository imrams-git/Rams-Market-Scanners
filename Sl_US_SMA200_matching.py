...
# ==========================================================
# PART 1: SPY 500 SMA & RSI SCANNER COMPONENTS
# ==========================================================
...
def fetch_sp500_tickers():
    ...
    "APH", "APP", "APTV", "ARE", "ARM", "ASGN", "ASML", "ATO", "AVB", "AVGO", "AVY", "AWK", "AXP", "AZN",
    "AZO", "BA", "BABA", "BAC", "BALL", "BAX", "BBAI", "BBY", "BDX", "BEN", "BIDU", "BIIB", "BILI", "BIO",
    "BJ", "BKNG", "BKR", "BLK", "BLMN", "BMRN", "BMY", "BR", "BRK-B", "BRO", "BSX", "BWA", "BX",
    "BXP", "C", "CAH", "CAKE", "CARR", "CAT", "CB", "CBOE", "CBRE", "CCI", "CCL", "CDNS", "CDW", "CE",
    "CEG", "CF", "CFG", "CHD", "CHH", "CHRW", "CHTR", "CI", "CINF", "CINT", "CL", "CLX", "CMCSA", "CME",
    "CMG", "CMI", "CMS", "CNC", "CNP", "COF", "COIN", "COO", "COST", "COTY", "CPB", "CPRT", "CPT", "CRL", "CRM",
    "CRWD", "CSCO", "CSX", "CTAS", "CTRA", "CTSH", "CTVA", "CUBE", "CVS", "CVX", "CZR", "D", "DAL", "DASH",
    "DD", "DDOG", "DE", "DFS", "DG", "DHR", "DIS", "DKNG", "DLR", "DLTR", "DOCU", "DOV", "DOW", "DPZ", "DRI",
    "DTE", "DUK", "DVA", "DVN", "DXC", "DXCM", "EA", "EAT", "EBAY", "ECL", "ED", "EFX", "EL", "ELV", "EMN",
    "EMR", "ENPH", "EOG", "EPAM", "EQIX", "EQR", "EQT", "ES", "ESS", "ETN", "EW", "EXC", "EXPD", "EXPE",
    "EXR", "F", "FAST", "FCX", "FDS", "FDX", "FE", "FFIV", "FGEN", "FIS", "FITB", "FLS", "FMC", "FOX",
    ...
    "HSY", "HUBB", "HUM", "HUN", "HWM", "IBM", "ICE", "IDXX", "IFF", "ILMN", "INCY", "INTC", "INTU", "INVH",
    ...
    "PM", "PNC", "PNR", "PODD", "POOL", "PPG", "PRU", "PSA", "PSX", "PTC", "PTON", "PYPL", "QCOM", "QQQ",
    "QSR", "RBLX", "RCL", "RDW", "REG", "REGN", "RF", "RGNX", "RHI", "RIVN", "RL", "RMD", "RNG", "ROK",
    "ROKU", "ROL", "ROP", "ROST", "RS", "RSG", "RTX", "SBAC", "SBUX", "SCHW", "SEDG", "SFM", "SHOP",
    ...
    "WH", "WHR", "WM", "WMB", "WMT", "WPC", "WRB", "WST", "WTW", "WY", "WYNN", "X", "XEL", "XOM",
...
def scan_stocks(progress_callback=None):
    ...
    if os.path.exists(filename):
        ...
        # FIX: threads=False prevents the MacOS open-file limit crash which was blocking the network
    ...
    for idx, ticker in enumerate(tickers):
        ...
        try:
            ...
            # FIX: Define 'eastern' timezone before calling datetime.now(eastern)
...
class VolumeAlertChecker:
    ...
    def print_unified_table(self, df: pd.DataFrame):
        ...
        print(f"\n🎯 US MARKET TARGETED SCAN RESULTS (Unified Table)")
    ...
    def run(self, symbols: List[str], n_bars: int = 100):
        ...
        print(f"\nFetching Daily Data for US Market...")
        valid_symbols = []
        daily_data_chunks = []
        ...
        filepath = os.path.join(output_dir, f"US_Pipeline_Results_{timestamp_str}.csv")
...
def main():
    if HAS_STREAMLIT and st.runtime.exists():
        st.set_page_config(page_title="SPY 500 Advanced Pipeline", layout="wide")
        st.title("📈 End-to-End SPY 500 Algorithmic Pipeline")
        st.write("Step 1: Scans SPY 500 for stocks bouncing 10% above 200 SMA with confirmed multi-timeframe RSI (>50).")
        ...
        if st.button("🚀 Run Full Pipeline Now", type="primary"):
            ...
            # --- STEP 1: SMA 200 SCAN ---
            st.subheader("Step 1: Executing SPY 500 Trend & Support Scan")
        ...
        print("\n" + "="*60)
        print("🚀 STEP 1: SCANNING SPY 500 FOR 200 SMA BOUNCE")
        print("="*60)
